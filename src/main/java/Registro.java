    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.println("""
                ...
                5) Mostrar la cantidad de personas según sexo.
                6)Salir.
                """);
            ...
            if(a == 1) {
                if(hayCupo(registro)) {
                    ...
                    registro[indiceDisponible][1] = sexo;
                ...
                for (double [] persona : registro) {
                    if (persona[2] >= 60 && persona[1].equals("M")) {
                        mmmm++;
                    } else if(persona[2] >= 65 && persona[1].equals("H")) {
                        mmmm++;
                    }
                }
                ...
                int d = 0;
                for(double[] persona : registro) {
                    if(persona[1].equals("H")) {
                        c++;
                    } else if(persona[1].equals("M")) {
                        d++;
                    }
                }

                System.out.println("Hay " + d + " hombres.");
                System.out.println("Hay " + c + " mujeres.");
            } else if(a == 6) {
